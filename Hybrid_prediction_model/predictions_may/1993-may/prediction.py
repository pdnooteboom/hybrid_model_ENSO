...
root_Dir_write = 'C:/Users/User/Documents/Thesis/Hybrid_prediction_model/predictions_may/1993-may/prediction'
...
testset = 10; print 'testset: ',testset # test set (%)
#%% Load the data
...
ARIMA_ninosq = np.loadtxt('nino1992-052017.txt')[:12,9]
nino = np.loadtxt('nino1992-052017.txt')[12:,9]

time = np.linspace(1993,2017.333333333333333333333,len(nino))
...
if(bc2):
    attr.append('c2')    
    c2 = np.load('c2_h_th09_1993.pny.npy')
    timec2 = np.load('timec2_1993.npy')
...
if(bPC2):
    attr.append('PC2')    
    PC2 = np.load('secondPC_WWB_weekly.npy')
    if(brunning_mean):       
